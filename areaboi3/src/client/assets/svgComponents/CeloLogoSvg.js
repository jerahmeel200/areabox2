...
function CeloLogoSvg({ fill }) {
  return (
    <svg
      id="Celo_Logotype"
      dataName="Celo Logotype"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 3952 1575">
      <defs>
        <style>.cls-1{{ fill: fill || '#fff' }}</style>
      </defs>
      ...
      <path
        id="Bottom_Ring"
        dataName="Bottom Ring"
        class="cls-1"
        d="M751,1105c154.64,0,280-125.36,280-280S905.64,545,751,545,471,670.36,471,825,596.36,1105,751,1105Zm0,95c-207.1,0-375-167.9-375-375S543.9,450,751,450s375,167.9,375,375S958.1,1200,751,1200Z"
      />
      <path
        id="Top_Ring"
        dataName="Top Ring"
        class="cls-1"
        d="M951,905c154.64,0,280-125.36,280-280S1105.64,345,951,345,671,470.36,671,625,796.36,905,951,905Zm0,95c-207.1,0-375-167.9-375-375S743.9,250,951,250s375,167.9,375,375S1158.1,1000,951,1000Z"
      />
    </svg>
  );
}

export default CeloLogoSvg;
