...
import AreaboiHelp from '../AreaboiHelp';
        ...
        {/* <Header subheader={
          <div>
            <div className="unreadNotif">
              <div>
                <span className="unreadBolt" style={{ 'marginTop': '2px', 'marginLeft': '15px' }}><img src="static/img/purple-lolly.svg" width="21px" height="21px" /></span>
              </div>
            </div>

            <a style={{ margin: '-22px auto' }} className="rooms_btn" title="Rooms">CINEMA</a>

            <a title="Rooms" className="rooms_icon">
              <span><img className="view_channels" src="static/img/cinematic.svg" /></span>
            </a>
        ...
        {/* <footer className="cinema-footer">
          <div className="cinema-footer-content">
            <nav className="cinema-footer-navs">
              <Link href="/"><a className="cinema-footer-nav">My Channels</a></Link>
              <Link href="/metro"><a className="cinema-footer-nav">Metro</a></Link>
              <Link href="/radio"><a className="cinema-footer-nav">Radio</a></Link>
              <Link href="/school"><a className="cinema-footer-nav">School</a></Link>
              <Link href="/trending"><a className="cinema-footer-nav">Trending</a></Link>
            </nav>
          </div>
