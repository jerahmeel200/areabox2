...
(function () {
  ...
  (c.prototype.noConflict = function () {
    ...
    (c.prototype.replace_colons = function (a) {
      ...
      return (
        ...
        a.replace(b.rx_colons, function (a) {
          ...
          if (
            (b.allow_caps && (c = c.toLowerCase()),
            c.indexOf('::skin-tone-') > -1)
          ) {
            var d = c.substr(-1, 1),
              e = 'skin-tone-' + d,
              f = b.map.colons[e];
    ...
    (c.prototype.replace_unified = function (a) {
      ...
      return (
        ...
        a.replace(b.rx_unified, function (a, c, d) {
          ...
          return (
            (e = b.map.unified_vars[c]),
            e
              ? b.replacement(e[0], null, null, {
                  idx: e[1],
                  actual: '',
                  wrapper: ''
                })
    ...
    (c.prototype.replacement = function (a, b, c, d, e) {
      var f = this,
        g = '',
        h = null;
      if (
        ('object' == typeof d &&
          ((g = f.replacement(d.idx, d.actual, d.wrapper, void 0, !0)),
          (h = d.idx)),
        (c = c || ''),
        f.colons_mode)
      )
        return ':' + f.data[a][3][0] + ':' + g;
      var i = b ? c + b + c : f.data[a][8] || c + f.data[a][3][0] + c;
      if (f.text_mode) return i + g;
      var j = f.find_image(a, h);
      if (
        (f.init_env(),
        'softbank' == f.replace_mode && f.allow_native && f.data[a][1])
      )
        return f.format_native(f.data[a][1] + g, !e);
      if ('google' == f.replace_mode && f.allow_native && f.data[a][2])
        return f.format_native(f.data[a][2] + g, !e);
      if ((j.is_var && (g = ''), 'unified' == f.replace_mode && f.allow_native))
        return f.format_native(j.unified + g, !e);
      var k = f.include_title ? ' title="' + (b || f.data[a][3][0]) + '"' : '',
        l = f.include_text ? c + (b || f.data[a][3][0]) + c : '';
      if (
        (f.data[a][7] &&
          ((j.path = f.data[a][7]),
          (j.px = null),
        ...
        j.is_var &&
          ...
          d.actual &&
          d.wrapper &&
          (l += d.wrapper + d.actual + d.wrapper),
        f.supports_css)
      ) {
        if (f.use_sheet && null != j.px && null != j.py) {
          var m = f.sheet_size * (j.sheet_size + 2),
            n = 100 * ((j.px * (j.sheet_size + 2) + 1) / (m - j.sheet_size)),
            o = 100 * ((j.py * (j.sheet_size + 2) + 1) / (m - j.sheet_size)),
            p = 100 * (m / j.sheet_size),
            q =
              'background: url(' +
              j.sheet +
              ');background-position:' +
    ...
    (c.prototype.format_native = function (a, b) {
      var c = this;
      return c.wrap_native && b
        ? '<span class="emoji-native">' + a + '</span>'
        : a;
    }),
    (c.prototype.find_image = function (a, b) {
      ...
      for (
        ...
        if (e & c.img_sets[g[h]].mask)
          return (
            (d.path =
              c.img_sets[g[h]].path + d.full_idx + '.png' + c.img_suffix),
            (d.sheet = c.img_sets[c.img_set].sheet),
            (d.sheet_size = c.img_sets[c.img_set].sheet_size),
            d
          );
        if (c.obsoletes_data[d.full_idx]) {
          var i = c.obsoletes_data[d.full_idx];
          if (i[3] & c.img_sets[g[h]].mask)
            return (
              (d.path = c.img_sets[g[h]].path + i[0] + '.png' + c.img_suffix),
              (d.sheet = c.img_sets[g[h]].sheet),
              (d.sheet_size = c.img_sets[g[h]].sheet_size),
              (d.px = i[1]),
              (d.py = i[2]),
              d
            );
      ...
      if (!a.inits.emoticons) {
        ...
        for (var c in a.emoticons_data) {
          var d = c
            ...
            .replace(/\</g, '&lt;')
            .replace(/\>/g, '&gt;');
          a.map.colons[a.emoticons_data[c]] &&
            ((a.map.emoticons[d] = a.map.colons[a.emoticons_data[c]]),
            b.push(a.escape_rx(d)));
        }
        a.rx_emoticons = new RegExp(
          '(^|\\s)(' + b.join('|') + ')(?=$|[\\s|\\?\\.,!])',
          'g'
        );
      }
    ...
    (c.prototype.init_colons = function () {
      ...
      if (!a.inits.colons) {
        (a.inits.colons = 1),
          (a.rx_colons = new RegExp(
            ':[a-zA-Z0-9-_+]+:(:skin-tone-[2-6]:)?',
            'g'
          )),
          (a.map.colons = {});
        for (var b in a.data)
          for (var c = 0; c < a.data[b][3].length; c++)
            a.map.colons[a.data[b][3][c]] = b;
      }
    }),
    (c.prototype.init_unified = function () {
      ...
      if (!a.inits.unified) {
        ...
        for (var c in a.data)
          for (var d = 0; d < a.data[c][0].length; d++)
            b.push(a.data[c][0][d].replace('*', '\\*')),
              (a.map.unified[a.data[c][0][d]] = c);
        for (var c in a.variations_data)
          if (a.variations_data[c]['1f3fb'][0] != c + '-1f3fb')
            for (var e in a.variations_data[c])
              for (var d = 0; d < a.variations_data[c][e][4].length; d++)
                b.push(a.variations_data[c][e][4][d].replace('*', '\\*')),
                  (a.map.unified_vars[a.variations_data[c][e][4][d]] = [c, e]);
        (b = b.sort(function (a, b) {
          return b.length - a.length;
        })),
          (a.rx_unified = new RegExp(
            '(' + b.join('|') + ')(\ud83c[\udffb-\udfff])?',
            'g'
          ));
      }
        ...
        if (
          ...
          if ('undefined' != typeof window && window.getComputedStyle)
            try {
              ...
              (c['background-size'] || c.backgroundSize) &&
                (a.supports_css = !0);
            } catch (d) {
              b.match(/Firefox/i) && (a.supports_css = !0);
            }
          if (b.match(/(iPhone|iPod|iPad|iPhone\s+Simulator)/i)) {
            if (b.match(/OS\s+[12345]/i))
              return void (a.replace_mode = 'softbank');
            if (b.match(/OS\s+[6789]/i))
              return void (a.replace_mode = 'unified');
          }
          if (b.match(/Mac OS X 10[._ ](?:[789]|1\d)/i))
            return void (a.replace_mode = 'unified');
          if (
            !a.avoid_ms_emoji &&
            (b.match(/Windows NT 6.[1-9]/i) ||
              b.match(/Windows NT 10.[0-9]/i)) &&
            !b.match(/Chrome/i) &&
            !b.match(/MSIE 8/i)
          )
            return void (a.replace_mode = 'unified');
